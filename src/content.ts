...
export const sources = [
  ...
  {
    id: 6,
    label: "Qonto Security",
    title: "Smart Security for Your Business",
    url: "https://qonto.com/en/security",
    note: "Public description of machine-learning signals, GenAI agents, automatic safeguards, and customer control.",
  },
  {
    id: 7,
    label: "Agent Controls",
    title: "Agent Control Specification and ASSERT",
    url: "https://devblogs.microsoft.com/foundry/build-2026-open-trust-stack-ai-agents/",
    note: "2026 reference for policy-driven evaluations and deterministic controls across model, state, tool, and output checkpoints.",
  },
  {
    id: 8,
    label: "Agent Operations",
    title: "AWS Well-Architected Agentic AI Lens",
    url: "https://docs.aws.amazon.com/wellarchitected/latest/agentic-ai-lens/agentic-ai-lens.html",
    note: "2026 reference for bounded autonomy, agent identity, memory, tool permissions, evaluation, tracing, and recovery.",
  },
  {
    id: 9,
    label: "EU AI Act",
    title: "How Are AI Agents Addressed Within the AI Act?",
    url: "https://ai-act-service-desk.ec.europa.eu/en/ai-act/faq/how-are-ai-agents-addressed-within-ai-act-0",
    note: "European Commission guidance on agent actions, transparency, safeguards, and evolving regulatory treatment.",
  },
];
